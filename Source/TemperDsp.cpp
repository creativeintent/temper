...
class TemperDsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Cutoff", &fHslider2, 16000.0f, 100.0f, 16000.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec5[0] = (fSlow1 + (0.995000005f * fRec5[1]));
			fRec7[0] = (fSlow2 + (0.995000005f * fRec7[1]));
			fRec8[0] = (fSlow3 + (0.995000005f * fRec8[1]));
			float fTemp0 = (1.0f / fRec8[0]);
			float fTemp1 = ((fRec7[0] * (fRec7[0] + fTemp0)) + 1.0f);
			fRec6[0] = (float(input0[i]) - (((fRec6[2] * ((fRec7[0] * (fRec7[0] - fTemp0)) + 1.0f)) + (2.0f * (fRec6[1] * (1.0f - TemperDsp_faustpower2_f(fRec7[0]))))) / fTemp1));
			float fTemp2 = ((fRec5[0] * fRec0[1]) + ((fRec6[2] + (fRec6[0] + (2.0f * fRec6[1]))) / fTemp1));
			float fTemp3 = fabsf(fTemp2);
			fRec4[0] = max(fTemp3, ((fConst2 * fRec4[1]) + (fConst3 * fTemp3)));
			fRec9[0] = (fSlow4 + (0.995000005f * fRec9[1]));
			float fTemp4 = min(3.0f, max(-3.0f, (fRec4[0] + (fRec9[0] * fTemp2))));
			fRec10[0] = (fSlow5 + (0.995000005f * fRec10[1]));
			float fTemp5 = TemperDsp_faustpower2_f(fRec10[0]);
			float fTemp6 = (fTemp5 * TemperDsp_faustpower2_f(fTemp4));
			float fTemp7 = (fTemp6 + 27.0f);
			float fTemp8 = ((9.0f * fTemp5) + 27.0f);
			float fTemp9 = (((9.0f * fTemp6) + 27.0f) * (fTemp5 + 27.0f));
			float fTemp10 = ((0.239999995f * ((((fRec3[0] * fTemp4) * fTemp7) * fTemp8) / fTemp9)) + ((1.0f - fRec3[0]) * fTemp2));
			fVec0[0] = fTemp10;
			fRec2[0] = (((0.239999995f * ((((fTemp10 * fTemp4) * fTemp7) * fTemp8) / fTemp9)) + fVec0[1]) + (fRec2[1] * (0.0f - (0.239999995f * (((fTemp4 * fTemp7) * fTemp8) / fTemp9)))));
